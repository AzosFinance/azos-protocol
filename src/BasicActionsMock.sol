 ...
 */
contract BasicActionsMock is CommonActions, IBasicActions {
  using Math for uint256;

  event CreateSafe(
    address indexed user, uint256 indexed amountCollateral, uint256 indexed amountCoin, bytes32 collateralType
  );
  ...
  function openLockTokenCollateralAndGenerateDebt(
    ...
    emit CreateSafe(msg.sender, _collateralAmount, _deltaWad, _cType);
  }
